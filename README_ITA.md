...
# Zentra Core - Versione 0.14.0 (Runtime Alpha)
...
> [!WARNING]
> **Stato Runtime Alpha**: Zentra Core è attualmente in `v0.14.0`. Questa repository contiene il motore, il backend, i moduli di ragionamento IA e la WebUI nativa principale. Le funzionalità possono cambiare e il sistema non è ancora considerato stabile. Usare con cautela.
...
Ora completamente migrato a una **architettura stabile a Plugin Nativi**, Zentra 0.14.0 offre una interfaccia Web dedicata (Chat + Config) e internazionalizzazione completa. Grazie a **LiteLLM**, supporta Ollama, KoboldCpp e i principali provider cloud con streaming in tempo reale e TTS locale.

---

## ✨ Caratteristiche Principali (v0.14.0)
