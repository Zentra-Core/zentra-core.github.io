...
**Version:** 0.15.0 (Zentra Drive & Standalone WebUI)
...
## 👁️ 5. Vision & Multimodal Interaction (v0.15.0)
...
Zentra 0.15.0 integrates a native and secure file manager, accessible at `http://localhost:7070/drive` (or by clicking the Drive link in the Config Panel Navbar).
...
Zentra 0.15.0 introduces an integrated **PKI (Public Key Infrastructure)** to ensure secure HTTPS connections across your entire local network.
