...
- **Isolamento Dati (User Vaults)**: Memorie, file personali e avatar sono isolati in cartelle protette (`memory/vaults/username`), impedendo l'accesso incrociato tra utenti.
