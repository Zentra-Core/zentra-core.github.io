...
> [!IMPORTANT]
> Zentra-Core è in una fase stabile di **v0.12.1 (Alpha)**. La sicurezza PKI, l'interfaccia mobile-first, il WebRTC Audio PTT, e la Navigazione Assoluta Drive (con Code Editor Monaco Extension) sono standard di sistema operativi che devono essere rigorosamente documentati e preservati in ogni modifica.
