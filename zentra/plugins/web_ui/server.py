...
class ZentraWebUIServer:
    ...
    def start(self) -> None:
        ...
        # Templates and Static files are inside this plugin's own folder
        tpl_dir = os.path.join(os.path.dirname(__file__), "templates")
        stc_dir = os.path.join(os.path.dirname(__file__), "static")
        app = Flask("ZentraWebUI", template_folder=tpl_dir, static_folder=stc_dir)
    ...
    with sys._zentra_webui_lock:
        ...
        try:
            ...
            if not alive:
                ...
                b_log.info(f"[WebUI] RESOLVED ROOT: {os.path.abspath(root_dir)}")
